...
function exibir(){
    ...
    if(nome && endereco && email && telefone){
        ...
        document.getElementById('dados-exibidos').innerHTML = '<p>Nenhum dado encontrado no local</p>';
    }
}
...
function enviar(){
    ...
    let data = "Nome: " + nome + "/n" + "Endereço: " + endereco + "/n" + "Email: "+ email + "/n" + "Telefone:" + telefone;
